...
observables_list = Observables(local_ip=local_ip, remote_ip=remote_ip, src_host=src_host, dst_host=dst_host, url=url,
                               remote_port=remote_port, protocol=protocol, app=app, user=user,
                               file_name=file_name, file_hash=file_hash, unix_cmd=cmd, unix_process=process,
                               severity=severity, sensor=sensor, action=action, incident_types=incident_types)
